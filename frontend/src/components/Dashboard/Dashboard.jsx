...
export default function Dashboard() {
  return (
    <div className="relative font-montserrat text-[#7c6a3c] pt-28 pb-16">
      {/* Top-right card */}
      <div
        className="absolute top-8 right-3 mr-25 w-[400px] h-[220px] bg-[#f9f6ef]/70 border-4 border-[#bfa14a] rounded-xl z-10 mt-18"
        style={{
      ...
      <div className="mt-8 max-w-6xl w-full ml-32">
        ...
        <button
          className="bg-[#bfa14a] text-white font-semibold rounded-lg px-5 py-2 mt-8 mb-6 ml-10 flex items-center gap-2"
          style={{
        ...
        {/* Dashboard Card */}
        <div
          className="bg-white rounded-2xl p-6 mt-12 w-full max-w-[1800px]"
          style={{
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              className="bg-[#bfa14a] text-white rounded-lg px-4 py-1 font-semibold"
              style={{
                border: '2px solid #bfa14a',
              }}
            >
          ...
          <div className="flex gap-2 mb-4">
            <span
              className="bg-[#bfa14a] text-white rounded-lg px-3 py-1 font-semibold"
              style={{
                border: '2px solid #bfa14a',
              }}
            >
            ...
            <span
              className="bg-[#e7d7b1] text-[#7c6a3c] rounded-lg px-3 py-1 font-semibold"
              style={{
                border: '2px solid #bfa14a',
              }}
            >
